...
describe('COMMON PULSECONNECTION', function(){
	
	var emitEventName = 'pulseConnectionPage';
	var okOnEventName = 'common_pulseConnectionPage';
	var errOnEventName = 'common_err_pulseConnectionPage';
	...
	it("Sending correct params -> should fire event "+okOnEventName,function(done){
		...
		process.on(okOnEventName, function(_socket, _sender, _request, _response){
